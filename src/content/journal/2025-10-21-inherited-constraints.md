...
status: published
featured: false
song: "Frozen Accidents"
notion_publish: false
notion_dirty: false
notion_last_published:
artwork_cover_prompt: "Abstract layered strata in coherenceism style. Deep historical layers at bottom (dense, darker soil and stone) with constraints dissolving upward into lighter, freer emerging patterns. Old forms composting into new growth. Square format (1:1 ratio). Deep soil (#4A3626), stone gray (#9B9B8C) at base transitioning to warm clay (#C4856C) and living gold (#D4A574) at top. Vertical movement showing evolution from constraint to freedom. Organic, breathing texture with visible layer boundaries that blur and transform. Natural grain showing historical depth. No text, no literal imagery, no photorealistic elements."
artwork_banner_prompt: "Abstract horizontal historical strata in coherenceism style. Left side shows dense, constrained layers (frozen accidents, old terminals) gradually dissolving and opening rightward into lighter, freer patterns (new possibilities). Wide banner format (3:1 ratio). Horizontal flow showing evolution from inherited constraint to deliberate choice. Deep soil (#4A3626), stone gray (#9B9B8C) transitioning to warm clay (#C4856C), living gold (#D4A574), and terracotta (#B87952) highlights. Layered transparency showing historical depth. Atmospheric space for text overlay. Breathing texture, soft transitions between eras. No text, no literal imagery, no photorealistic elements."
---
