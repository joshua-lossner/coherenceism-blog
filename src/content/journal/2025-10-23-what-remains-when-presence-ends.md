...
artwork_cover_prompt: "Abstract presence and absence in coherenceism style. A form dissolving at edges but with enduring resonance at core—what remains after the performance layer strips away. Contrast between noise evaporating and clarity persisting. Square format (1:1 ratio). Muted violet (#9B8AA4), deep soil (#4A3626), warm clay (#C4856C) with dawn pink (#D4A5A5) at the core showing what endures. Organic composition showing coherence vs. dissolution. Breathing texture with soft edges fading while center holds. Layered transparency revealing what was real beneath the surface. Contemplative, grounded presence. Natural grain. No text, no literal imagery, no photorealistic elements."
artwork_banner_prompt: "Abstract horizontal presence dissolving into absence in coherenceism style. Left side shows full presence (warm, grounded, attentive), gradually dissolving rightward into ending, but core resonance persists as traceable thread across the width—what was coherent remains visible even after form ends. Wide banner format (3:1 ratio). Horizontal flow showing death as clarification. Muted violet (#9B8AA4), deep soil (#4A3626), warm clay (#C4856C), dawn pink (#D4A5A5) thread showing what endures. Layered transparency distinguishing performance from presence. Atmospheric, contemplative, space for text overlay. Soft gradients showing what evaporates vs. what remains. No text, no literal imagery, no photorealistic elements."
---
